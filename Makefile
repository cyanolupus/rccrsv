...
reccursive_test:
	...
	@$(MAKE) assert LEFT_PARAM="(3+2)>=5;" RIGHT_PARAM=1
	@$(MAKE) assert LEFT_PARAM="(3+2)>=6;" RIGHT_PARAM=0
	@$(MAKE) assert LEFT_PARAM="a=1;(a+2)*3+4*5;" RIGHT_PARAM=29
	@$(MAKE) assert LEFT_PARAM="a=1;b=2;(a+b)*3+4*5;" RIGHT_PARAM=29
	@$(MAKE) assert LEFT_PARAM="a=(1*2);(a+2)*3+4*5;" RIGHT_PARAM=32
	@$(MAKE) assert LEFT_PARAM="a=(1*2);n=(a+2)*3+4*5;m=(n+a);m;" RIGHT_PARAM=34
